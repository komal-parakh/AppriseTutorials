...
<html lang="en-IN">
<head>
    <title> Classes | ApprizeTutorial </title>
    ...
    <body>
        <div class="content-1">
            <?php foreach ($results as $row): ?>
                <div class="card-1">
                    <a href="subject.php?SubjectID=<?php echo $row['SubjectID']; ?>"><?php echo htmlspecialchars($row['Name']); ?></a>
                </div>
            <?php endforeach; ?>
            <div class="card-1">
        <div class="action-btns">
            <a href="progress.php">Progress Report</a>
        </div>
</div>
</div>
